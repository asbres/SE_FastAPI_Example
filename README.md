...
После запуска Streamlit-приложения пользователь может загрузить изображение в одном из поддерживаемых форматов: JPG, JPEG, PNG или WEBP. Затем приложение отображает исходное изображение, маску сегментации и результат удаления фона.
